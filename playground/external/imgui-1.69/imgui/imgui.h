...
namespace ImGui
{
    void SdeImguiInit();        // Having wierd link issues, this 'fixed it', name mangling probably
    void SdeImguiShutdown();    // Having wierd link issues, this 'fixed it', name mangling probably
