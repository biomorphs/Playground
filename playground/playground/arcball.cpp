...
Arcball::Arcball(glm::ivec2 windowSize, glm::vec3 pos, glm::vec3 target, glm::vec3 up)
...
void Arcball::Update(const Input::MouseRawState& ms, float deltaTime)
{
	if (ms.m_buttonState & Input::LeftButton)
	{
		if (!m_enabled)
		{
